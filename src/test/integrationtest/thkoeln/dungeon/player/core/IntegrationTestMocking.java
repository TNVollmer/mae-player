...
@Component
public class IntegrationTestMocking {
    ...
    protected void mockPlayerPost() throws Exception {
        ...
        mockServer.expect( ExpectedCount.manyTimes(), MockRestRequestMatchers.requestTo( playersPostURI ) )
    ...
    protected void mockPlayerGetNotFound() throws Exception {
        mockServer.expect( ExpectedCount.manyTimes(), MockRestRequestMatchers.requestTo(playersGetURI) )
    ...
    protected void mockGamesGetWithRunning() throws Exception {
        openGameId = null;
        mockServer.expect( ExpectedCount.manyTimes(), MockRestRequestMatchers.requestTo( gamesURI ) )
                .andExpect( MockRestRequestMatchers.method(HttpMethod.GET) )
