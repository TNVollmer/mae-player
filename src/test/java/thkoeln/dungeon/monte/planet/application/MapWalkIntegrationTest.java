...
@SpringBootTest
public class MapWalkIntegrationTest {
    private Logger logger = LoggerFactory.getLogger(MapWalkIntegrationTest.class);
    ...
    private Coordinate randomCoordinate() {
        ...
        c.x = random.nextInt( MapWalkIntegrationTest.DIM_X );
        c.y = random.nextInt( MapWalkIntegrationTest.DIM_Y );
        return c;
    }
