...
@NoArgsConstructor
@Service
public class __OBSOLETE_RabbitMQListener {
    private Logger logger = LoggerFactory.getLogger(__OBSOLETE_RabbitMQListener.class);
    private EventCallback eventCallback;
    private String playerQueue;

    public __OBSOLETE_RabbitMQListener(String playerQueue, EventCallback eventCallback ) {
